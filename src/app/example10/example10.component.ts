...
@Component({
  ...
  template: `
    ...
    <div class="item-content item-text">The question appears to indicate that there is only one incorrect answer, when, in fact, there are two incorrect answers.</div>
  `,
  styles: [],
})
